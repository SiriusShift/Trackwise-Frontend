...
const TrackerCardEmpty = () => {
  return (
    <CarouselItem className="basis-full xl:basis-1/2">
      <CardContent className="flex h-full justify-center items-center p-3 gap-3 border-2 border-dashed rounded-lg">
