...
const Dashboard = () => {
  ...
  return (
    <div className="2xl:grid-cols-4 gap-5 grid 2xl:grid-rows-1">
      <div className="2xl:col-span-3 flex flex-col gap-5">
        ...
        <div className="grid grid-cols-4 md:grid-rows-1 lg:grid-rows-1 gap-5">
          <div className="border rounded-lg col-span-2 md:col-span-2 xl:col-span-1 h-44 border-gray-100 shadow-md"></div>
          <div className="border rounded-lg col-span-2 md:col-span-2 xl:col-span-1 h-44 border-gray-100 shadow-md"></div>
          <div className="border rounded-lg col-span-2 md:col-span-2 xl:col-span-1 h-44 border-gray-100 shadow-md"></div>
          <div className="border rounded-lg col-span-2 md:col-span-2 xl:col-span-1 h-44 border-gray-100 shadow-md"></div>
        </div>
        <div className="grid-rows-2 gap-5 lg:grid-rows-1 grid grid-cols-3">
          <Card className="col-span-4  lg:col-span-3 border rounded-lg border-gray-100 shadow-md">
            ...
            <CardContent>
              <ChartContainer
                className="h-[300px] lg:h-[300px] mt-5 w-full"
                config={chartConfig}
              >
                <BarChart
                  data={chartData}
      ...
      <div className="border rounded-lg w-full col-span-1 border-gray-100 shadow-md h-full">
        hello
      </div>
    </div>
  );
