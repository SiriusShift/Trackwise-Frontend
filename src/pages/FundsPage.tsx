...
import { Expense, columns } from "@/components/columns/fundsColumns";
import { useState, useEffect } from "react";


/*************  ✨ Codeium Command ⭐  *************/
/**
 * Fetches a list of mock expenses data.
 *
 * @returns {Promise<Expense[]>} A promise that resolves to an array of Expense objects.
 * Each expense object contains details such as id, date, category, description, amount, paymentMethod, and status.
 */
/******  e2091149-7575-4845-9139-56ca341db4cb  *******/async function getData(): Promise<Expense[]> {
